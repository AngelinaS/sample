...
public class AdminPage extends WebPage {
    ...
    public AdminPage() {
        ...
        Object sessijaname = (((MySession)Session.get()).getMyObject());
        Label userlogin = new Label("userpage", new Model(sessijaname.toString()));
        ...
        Button addHotel = new Button("addhotel"){
            @Override
            public void onSubmit (){
                setResponsePage(new AddHotelPage());
            }
        };
        form.add(addHotel);
